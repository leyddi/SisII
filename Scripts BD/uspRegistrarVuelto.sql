...
-- Example: EXEC
-- =============================================
ALTER PROCEDURE uspRegistrarVuelto
@PI_ID_VENTA INT,
@PI_ID_PAGO INT
AS
BEGIN	
	...
	BEGIN
		...
		INSERT INTO DETALLE_CAJA (ID_MONEDA,MONTO, MONTO_BS, TIPO_CAMBIO,ID_CAJA, TIPO) VALUES (1,@DIFERENCIA*-1,@DIFERENCIA*-1,1, @V_ID_CAJA, 'Vuelto')
