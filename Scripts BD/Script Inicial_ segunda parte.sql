...
INSERT INTO SERIES(SERIE,CORRELATIVO,ACTIVO) VALUES ('F001',0,1)


ALTER TABLE CAJA ADD ID_MONEDA INT

ALTER TABLE CAJA ADD CONSTRAINT FK_CAJA_MONEDA FOREIGN KEY (ID_MONEDA) REFERENCES MONEDA(ID)

ALTER TABLE DETALLE_CAJA ADD APERTURA BIT DEFAULT 0
